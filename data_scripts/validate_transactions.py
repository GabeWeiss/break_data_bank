...
def validate_and_copy_data(jobs_filename, cached_location):
    ...
    for job_id in JOBS_FILE:
        ...
        try:
            ...
            write_log(LOG_LVL_WARNING, f"Didn't have the data for the job in Firestore: {job_id}")
            continue
        ...
        for t in transactions:
            ...
            try:
                ...
                write_log(LOG_LVL_FATAL, f"Transaction '{t.id}' in job '{job_id}' has no timestamp, ending validation.")
                return False
